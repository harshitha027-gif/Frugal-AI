                ...
                <div className="container mx-auto px-6 lg:px-12 max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                        ...
                        <div className="flex flex-col justify-center pt-32 pb-12 lg:py-0">
                            <span className="inline-block w-fit px-4 py-1.5 mb-8 text-sm font-medium rounded-full bg-primary/10 text-primary border border-primary/20 backdrop-blur-sm">
                                🚀 The future of efficient AI
                            </span>

                            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-8 tracking-tighter text-foreground leading-[0.9] text-balance">
                                Frugal <br />
                            ...
                            <div className="flex flex-wrap gap-5">
                                <Link
                                    href="/tools"
                                    className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 text-lg font-semibold rounded-full bg-primary text-primary-foreground overflow-hidden transition-all hover:scale-105 hover:bg-primary-dark shadow-[0_0_40px_rgba(16,185,129,0.3)] hover:shadow-[0_0_60px_rgba(16,185,129,0.5)]"
                                >
                                ...
                                <Link
                                    href="/docs"
                                    className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold rounded-full border border-border text-muted-foreground hover:text-foreground hover:border-foreground/50 hover:bg-foreground/5 transition-all"
                                >
                                    How it works
                                </Link>
                            </div>
