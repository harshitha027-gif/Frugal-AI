...
export default function DocumentationPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white pt-24">
            ...
            <div className="lg:hidden fixed top-24 left-0 right-0 z-40 bg-[#0a0a0a] border-b border-white/5 px-6 py-4 flex items-center justify-between">
                <span className="text-sm font-bold text-neutral-400">Documentation Menu</span>
            ...
            <div className="container mx-auto px-6 max-w-7xl flex gap-12 relative">
                ...
                {/* Sidebar Navigation */}
                <aside className={`fixed lg:sticky top-24 lg:top-32 left-0 h-[calc(100vh-8rem)] w-64 bg-[#0a0a0a] border-r border-white/5 lg:border-none p-6 lg:p-0 z-30 transition-transform duration-300 lg:translate-x-0 overflow-y-auto ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'
                    }`}>
                    <h5 className="text-sm font-bold text-white mb-6 uppercase tracking-wider px-4">Contents</h5>
                ...
                <main className="flex-1 w-full lg:max-w-4xl py-12 lg:py-0 pb-32 space-y-20">
                    ...
                    <section id="introduction" className="space-y-6 scroll-mt-32">
                        <div className="inline-flex items-center gap-2 px-3 py-1 text-sm font-medium rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 mb-4">
                            <FileText className="w-4 h-4" />
                            <span>Documentation v1.0</span>
                        </div>
                        <h1 className="text-4xl md:text-5xl font-bold tracking-tight">Frugal AI Documentation</h1>
                    ...
                    {/* Mission */}
                    <section id="mission" className="space-y-6 scroll-mt-32 pt-12 border-t border-white/5">
                        ...
                        <div className="grid md:grid-cols-2 gap-6 mt-6">
                            <div className="bg-[#111] p-6 rounded-2xl border border-white/5">
                                <h3 className="font-bold text-white mb-2">Democratize Access</h3>
                                <p className="text-sm text-neutral-400">Making powerful AI accessible on consumer hardware (edge devices, laptops, mobile).</p>
                            </div>
                            <div className="bg-[#111] p-6 rounded-2xl border border-white/5">
                                <h3 className="font-bold text-white mb-2">Reduce Carbon Footprint</h3>
                                <p className="text-sm text-neutral-400">Promoting energy-efficient models effectively lowers global cognitive compute energy consumption.</p>
                            </div>
                        </div>
                    </section>

                    {/* Features */}
                    <section id="features" className="space-y-6 scroll-mt-32 pt-12 border-t border-white/5">
                        <h2 className="text-3xl font-bold flex items-center gap-3">
                            <Zap className="w-6 h-6 text-yellow-400" />
                            Key Features
                        </h2>
                        <ul className="space-y-4 text-neutral-300 list-disc list-inside">
                            <li><strong className="text-white">Curated Marketplace:</strong> Discover verified low-resource tools.</li>
                            <li><strong className="text-white">Smart Auto-Import:</strong> Instantly add tools from Hugging Face or GitHub.</li>
                            <li><strong className="text-white">Carbon Scoring:</strong> A community-driven metric (0-100) to rate efficiency.</li>
                            <li><strong className="text-white">Creator Profiles:</strong> Showcase your portfolio of efficient AI contributions.</li>
                        </ul>
                    </section>

                    {/* Getting Started */}
                    <section id="getting-started" className="space-y-6 scroll-mt-32 pt-12 border-t border-white/5">
                    ...
                    {/* Submitting Tools */}
                    <section id="submitting-tools" className="space-y-6 scroll-mt-32 pt-12 border-t border-white/5">
                        <h2 className="text-3xl font-bold flex items-center gap-3">
                        ...
                        <ol className="list-decimal list-inside space-y-4 text-neutral-300 bg-[#111] p-8 rounded-3xl border border-white/5">
                    ...
                    {/* Auto-Import API */}
                    <section id="auto-import" className="space-y-6 scroll-mt-32 pt-12 border-t border-white/5">
                        <h2 className="text-3xl font-bold flex items-center gap-3">
                        ...
                        <div className="grid gap-4">
                            <div className="p-4 bg-neutral-900 border border-white/5 rounded-xl">
                                <h4 className="font-bold text-white mb-2">Hugging Face Detection</h4>
                                <code className="text-xs text-neutral-400 block bg-black p-3 rounded-lg mb-2">
                                    Input: "TheBloke/Llama-2-7B-Chat-GGML"
                                </code>
                                <p className="text-sm text-neutral-500">Fetches metadata from HF Hub API and resolves README.md from main/master branch.</p>
                            </div>
                            <div className="p-4 bg-neutral-900 border border-white/5 rounded-xl">
                                <h4 className="font-bold text-white mb-2">GitHub Detection</h4>
                                <code className="text-xs text-neutral-400 block bg-black p-3 rounded-lg mb-2">
                                    Input: "https://github.com/microsoft/DeepSpeed"
                                </code>
                                <p className="text-sm text-neutral-500">Extracts owner/repo, calls GitHub API for description, and fetches raw content of README.md.</p>
                            </div>
                        </div>
                    </section>

                    {/* Carbon Score */}
                    <section id="carbon-score" className="space-y-6 scroll-mt-32 pt-12 border-t border-white/5">
                        <h2 className="text-3xl font-bold flex items-center gap-3">
                        ...
                        <p className="text-sm text-neutral-400 mt-2">
                            <strong>Note:</strong> Since exact energy consumption varies by hardware, this score serves as a comparative guide rather than a precise scientific measurement.
                        </p>
                    </section>

                    {/* FAQ */}
                    <section id="faq" className="space-y-6 scroll-mt-32 pt-12 border-t border-white/5">
                        <h2 className="text-3xl font-bold">Frequently Asked Questions</h2>

                        <div className="space-y-4">
                            <details className="group bg-[#111] p-6 rounded-2xl border border-white/5 open:border-emerald-500/30 transition-all">
